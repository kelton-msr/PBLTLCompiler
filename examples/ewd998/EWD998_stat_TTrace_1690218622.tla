---- MODULE EWD998_stat_TTrace_1690218622 ----
...
_inv ==
    ~(
        ...
        hasEmittedCSV = (FALSE)
        /\
        color = ((0 :> "black" @@ 1 :> "black" @@ 2 :> "white" @@ 3 :> "white"))
        /\
        pending = ((0 :> 0 @@ 1 :> 0 @@ 2 :> 0 @@ 3 :> 0))
        /\
        active = ((0 :> TRUE @@ 1 :> TRUE @@ 2 :> TRUE @@ 3 :> TRUE))
        /\
        counter = ((0 :> 0 @@ 1 :> -1 @@ 2 :> 1 @@ 3 :> 0))
        /\
        token = ()
    )
----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("EWD998_stat_TTrace_1690218622.json", _TETrace)
...
\*
\*trace == IODeserialize("EWD998_stat_TTrace_1690218622.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    <<
    ([c |-> [temp |-> [counter |-> 0, condition |-> FALSE, hasAntecedent |-> FALSE]],hasEmittedCSV |-> FALSE,color |-> (0 :> "black" @@ 1 :> "white" @@ 2 :> "white" @@ 3 :> "white"),pending |-> (0 :> 0 @@ 1 :> 0 @@ 2 :> 0 @@ 3 :> 0),active |-> (0 :> TRUE @@ 1 :> FALSE @@ 2 :> TRUE @@ 3 :> TRUE),counter |-> (0 :> 0 @@ 1 :> 0 @@ 2 :> 0 @@ 3 :> 0),token |-> [pos |-> 0, q |-> 0, color |-> "black"]]),
    ([c |-> [temp |-> [counter |-> 0, condition |-> FALSE, hasAntecedent |-> FALSE]],hasEmittedCSV |-> FALSE,color |-> (0 :> "black" @@ 1 :> "white" @@ 2 :> "white" @@ 3 :> "white"),pending |-> (0 :> 0 @@ 1 :> 1 @@ 2 :> 0 @@ 3 :> 0),active |-> (0 :> TRUE @@ 1 :> FALSE @@ 2 :> TRUE @@ 3 :> TRUE),counter |-> (0 :> 0 @@ 1 :> 0 @@ 2 :> 1 @@ 3 :> 0),token |-> [pos |-> 0, q |-> 0, color |-> "black"]]),
    ([c |-> [temp |-> [condition |-> FALSE, counter |-> 0, hasAntecedent |-> FALSE]],hasEmittedCSV |-> FALSE,color |-> (0 :> "black" @@ 1 :> "black" @@ 2 :> "white" @@ 3 :> "white"),pending |-> (0 :> 0 @@ 1 :> 0 @@ 2 :> 0 @@ 3 :> 0),active |-> (0 :> TRUE @@ 1 :> TRUE @@ 2 :> TRUE @@ 3 :> TRUE),counter |-> (0 :> 0 @@ 1 :> -1 @@ 2 :> 1 @@ 3 :> 0),token |-> ])
    >>
----
...
---- CONFIG EWD998_stat_TTrace_1690218622 ----
CONSTANTS
    N = 4
...
ALIAS
    _expression
=============================================================================
\* Generated on Mon Jul 24 10:10:22 PDT 2023